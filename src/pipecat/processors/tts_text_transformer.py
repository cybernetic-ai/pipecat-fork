...
class TTSTextTransformer:
    ...
    DATE_LONG_ATTACHED_PATTERN = r'\b(January|February|March|April|May|June|July|August|September|October|November|December)([0-9]{1,2})(st|nd|rd|th)?\b'
    DATE_SHORT_ATTACHED_PATTERN = r'\b(Jan|Feb|Mar|Apr|May|Jun|Jul|Aug|Sep|Sept|Oct|Nov|Dec)(\.?)([0-9]{1,2})(st|nd|rd|th)?\b'
